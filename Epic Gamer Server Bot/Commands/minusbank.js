...
module.exports = {
  ...
  async execute(message, args, cmd, client, discord, profileData) {
    ...
    if (amount % 1 != 0 || amount > 0) return message.channel.send("The reduce amount has to be a whole number, nor can it be positive. Correct usage: $minusbank @target -amount");
