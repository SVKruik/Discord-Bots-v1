module.exports = {
  ...
  execute(message, args, cmd, client, Discord) {
    ...
    const bthreeabcformule = cirkela2cirkelb2keeraformuleom * cirkela2cirkelb2keeraformuleom
    ...
    const newEmbed = new Discord.MessageEmbed()
      ...
      .setDescription("Dit stappenplan laat zien hoe je een Substitutie berekening maakt. Dit is een vrij complexe berekening binnen de Wiskunde B.")
      .addFields(
        {
          name: `1. Opdracht:`,
