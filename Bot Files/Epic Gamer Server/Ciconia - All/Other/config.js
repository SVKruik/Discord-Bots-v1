...
exports.test = {
    testmessage: 'If you see this, something you are trying worked',
...
exports.aliases = {
    ...
    aliasesminusfulleco : ["minusbankwal", "minuswalbank", "minbankwal", "minwalbank"], // Minusbankandwallet
    aliasesminuswallet : ["minwal"], // Minuswallet
    aliasessearch : ["srch"], // Search
    aliasessetbank : [], // Setbank
    aliasessetfulleco : ["setwalbank", "setwalletbank", "setbankwallet", "setbankwal"], // Setbankandwallet
    ...
    aliasesgivefulllevel : ["givelvlxp", "givexplvl", "givelvlexp", "giveexplvl", "givefullevel"], // Givelevelandexperience
    ...
    aliasesminusfulllevel : ["minuslvlxp", "minusxplvl", "minusexplvl", "minuslvlexp", "minlvlxp", "minxplvl", "minexplvl", "minlvlexp", "minusfullevel"], // Minuslevelandexperience
...
exports.descriptions = {
    ...
    descriptiongivefulleco : "Increase the balance of both the bank and wallet account.",
    descriptiongivewallet : "Increase the balance of a member.",
    descriptionminusbank : "Decreases the balance of the bank account.",
    descriptionminusfulleco : "Decreases the balance of both the wallet and the bank account.",
    ...
    descriptionminusfulllevel : "Decreases the amount of both your experience and levels.",
    ...
    descriptionembedtemplate : "Embed template for bot developers. Isn't meant to be used.",
    ...
    descriptionplay : "Music Bot via YouTube links. You must be in a call for it to work.",
    descriptionapply : "Sends you the link where you can apply to one of our roles/ranks.",
    descriptioncommandtemplate : "Command template for bot developers. Isn't meant to be used.",
    ...
    descriptionhoeklijn : "calculate the angle between 2 lines crossing each other.",
