        ...
        try {
            ...
            const newEmbed1 = new Discord.MessageEmbed()
                ...
                .addFields(
                    ...
                    {
                        name: config.embeds.nameboxeschances2,
                        value: `\`${chanceultraexotic}%\` **---** \`${amountultraexotic}\``
                    },
                    {
                        name: config.embeds.nameboxeschances3,
                        value: `\`${chanceultralegendary}%\` **---** \`${amountultralegendary}\``
                    },
                    {
                        name: config.embeds.nameboxeschances4,
                        value: `\`${chanceultraepic}%\` **---** \`${amountultraepic}\``
                    },
                    {
                        name: config.embeds.nameboxeschances5,
                        value: `\`${chanceultrarare}%\` **---** \`${amountultrarare}\``
                    },
                    { name: config.embeds.nameboxeschances6, value: `> **Super Box**` },
                    {
                        name: config.embeds.nameboxeschances7,
                        value: `\`${chancesuperlegendary}%\` **---** \`${amountsuperlegendary}\``
                    },
                    {
                        name: config.embeds.nameboxeschances8,
                        value: `\`${chancesuperepic}%\` **---** \`${amountsuperepic}\``
                    },
                    {
                        name: config.embeds.nameboxeschances9,
                        value: `\`${chancesuperrare}%\` **---** \`${amountsuperrare}\``
                    },
                    {
                        name: config.embeds.nameboxeschances10,
                        value: `\`${chancesuperuncommon}%\` **---** \`${amountsuperuncommon}\``
                    },
                    {
                        name: config.embeds.nameboxeschances11,
                        value: `\`${chancesupercommon}%\` **---** \`${amountsupercommon}\``
                    },
                    { name: config.embeds.nameboxeschances12, value: `> **Normal Box**` },
                    {
                        name: config.embeds.nameboxeschances13,
                        value: `\`${chancenormalrare}%\` **---** \`${amountnormalrare}\``
                    },
                    {
                        name: config.embeds.nameboxeschances14,
                        value: `\`${chancenormaluncommon}%\` **---** \`${amountnormaluncommon}\``
                    },
                    {
                        name: config.embeds.nameboxeschances15,
                        value: `\`${chancenormalcommon}%\` **---** \`${amountnormalcommon}\``
                    },
                )
