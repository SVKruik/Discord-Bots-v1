  ...
  execute(message, args, cmd, client, Discord) {
    ...
    const newEmbed = new Discord.MessageEmbed()
      ...
      .addFields(
        ...
        { name: config.embeds.nameprofile4, value: `${economyData.userID}` },
        { name: config.embeds.nameprofile5, value: `${economyData.serverID}` },
        { name: config.embeds.nameprofile6, value: "> **Economy:**" },
        { name: config.embeds.nameprofile7, value: `${economyData.wallet}` },
        { name: config.embeds.nameprofile8, value: `${economyData.bank}` },
        { name: config.embeds.nameprofile9, value: "> **Level:**" },
        { name: config.embeds.nameprofile10, value: `${economyData.level}` },
        { name: config.embeds.nameprofile11, value: `${economyData.experience}` },
        { name: config.embeds.nameprofile12, value: "> **Technical:**" },
        { name: config.embeds.nameprofile13, value: `${economyData._id}` },
        { name: config.embeds.nameprofile14, value: `${economyData.__v}` },
      )
