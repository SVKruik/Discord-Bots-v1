...
class I18nProvider {
    ...
    loadFromLocale(locale) {
        ...
        if (!loaded && locale && locale.startsWith(I18nProvider.FILEPATH_PREFIX)) {
            filepath = path_1.default.resolve(process.cwd(), locale.substr(I18nProvider.FILEPATH_PREFIX.length));
        }
        try {
            if (filepath) {
    ...
    static flatten(object, path = null, separator = '.') {
        return Object.keys(object).reduce((acc, key) => {
            const newPath = [path, key].filter(Boolean).join(separator);
            return typeof (object === null || object === void 0 ? void 0 : object[key]) === 'object'
                ? Object.assign(Object.assign({}, acc), I18nProvider.flatten(object[key], newPath, separator)) : Object.assign(Object.assign({}, acc), { [newPath]: object[key] });
        }, {});
    }
}
