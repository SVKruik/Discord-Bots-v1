    ...
    requestDuel(tunnel, invited) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (this.validator.isInteractionValid(tunnel, invited)) {
                const duel = new DuelRequest_1.default(this, tunnel, invited, this.bot.configuration.requestExpireTime);
                const message = yield tunnel.replyWith({ embed: duel.embed });
